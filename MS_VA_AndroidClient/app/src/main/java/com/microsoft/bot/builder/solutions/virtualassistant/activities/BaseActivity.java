...
import com.microsoft.bot.builder.solutions.virtualassistant.utils.ExceptionHandler;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void initializeAndConnect(){
        if (speechServiceBinder != null && InternetConnected()) {
            try {
            ...
            Log.e(LOGTAG, InternetConnected()?"do not have a binding to the service":"no Internet connection");
        }
    }
    ...
    protected boolean InternetConnected() {
