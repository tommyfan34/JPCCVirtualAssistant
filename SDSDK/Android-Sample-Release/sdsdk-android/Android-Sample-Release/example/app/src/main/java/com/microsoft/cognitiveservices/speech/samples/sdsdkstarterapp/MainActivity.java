...
public class MainActivity extends AppCompatActivity {
    ...
    // Subscription
    private static String SpeechSubscriptionKey = "337b9e222dfe49e284db8f996573022e"; // "337b9e222dfe49e284db8f996573022e"
    private static String SpeechRegion = "chinaeast2";// "chinaeast2"; // You can change this if your speech region is different.
    private static String LuisSubscriptionKey = "2f057d50883f4f9ba93ba1b9eab90008";//"2f057d50883f4f9ba93ba1b9eab90008";
    private static String LuisRegion = "westus"; // you can change this, if you want to test the intent, and your LUIS region is different.
    private static String LuisAppId = "c4e41f23-28af-42b3-bfb5-96061f3798a8"; //"c4e41f23-28af-42b3-bfb5-96061f3798a8";

    private static String Keyword = "computer";
    private static String KeywordModel = "computer.zip";// set your own keyword package name. 

    private static String DeviceGeometry = "Linear4"; //"Circular6+1", "Linear4",
    private static String SelectedGeometry = "Linear4"; //"Circular6+1", "Circular3+1", "Linear4", "Linear2"
...
//    private Button ctsButton;
    ...
    private SpeechSynthesizer synthesizer = new SpeechSynthesizer(getSpeechConfig_trans(), AudioConfig.fromDefaultSpeakerOutput());
    ...
    public static SpeechConfig getSpeechConfig_trans() {
        SpeechConfig speechConfig = SpeechConfig.fromSubscription(SpeechSubscriptionKey, SpeechRegion);
    ...
    // hide keyboard when clicking blank
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ttsInput = findViewById(R.id.inputText);
        ttsInput.clearFocus();
        ...
        recognizeKwsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                content.add("");
                content.add("");
                Log.i(logTag,validateMicAvailability()?"accessible":"not accessible");
                try {
                    reco = new SpeechRecognizer(getSpeechConfig(), getAudioConfig());
